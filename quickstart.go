...
func listCommentsByVideoId(service *youtube.Service,
	parts []string,
	videoId string,
) {
...
func main() {
	...
	videoId := "6V2kMynnQ7M"
	getVideoInfo(service, []string{"snippet", "id"}, videoId)
	listCommentsByVideoId(service, []string{"snippet", "id", "replies"}, videoId)
}
